window.BMAP_AUTHENTIC_KEY = ""; (function() {
    ...
    z.ma = getRootPath() + "/Content/Scripts/plugins/offlineBMap/";
            ...
            if (d.Bd == this.Fj.Zp) c && b();
                ...
                if (d.Bd == this.Fj.hG) {
                    ...
                    e.zC == q && (e.zC = o, setTimeout(function() {
                        ...
                        if (a.length > 0) {
                            console.log(a);
                            Pb(getRootPath() + "/Content/Scripts/plugins/offlineBMap/js/getmodules.js");
                        } else {
                            e.LK()
                        }
                    },
    ...
    function Hc(a, b, c, d, e) {
        ...
        if (/^http/.test(b)) {
            ...
            this.src = getRootPath() + "/Content/Scripts/plugins/offlineBMap/" + b;
        }     
    ...
    Uc.getTilesUrl = function (a, b, c) {
        ...
        //return "http://localhost:908/MapTiles/" + z + "/" + x + "/" + y + ".png";
    };
    var La = new Qc("\u5730\u56fe", Uc, {
        tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
        maxZoom: 19
